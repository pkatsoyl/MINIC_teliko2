...
bool CSTNode::m_continueVisit = false;
...
const char* g_nodeTypeLabels[] = {"COMPILEUNIT","FUNCTIONDEFINITION" ,"FORMALARGS" ,"ACTUALARGS","EXPRESSIONSTATEMENT",
								  "COMPOUNDSTATEMENT", "IFSTATEMENT", "WHILESTATEMENT", "DOWHILESTATEMENT", "FORSTATEMENT", "RETURNSTATEMENT","BREAKSTATEMENT","CONTINUESTATEMENT",
								  "NULLSTATEMENT",
