...
protected:
	...
	CStatement(NodeType tp, int children, CSTNode* arg1, CSTNode* arg2, CSTNode* arg3, CSTNode* arg4);
...
public:
	CDoWhileStatement(CSTNode* body, CSTNode* cond);
...
public:
	CForStatement(CSTNode* cond1, CSTNode* cond2, CSTNode* cond3, CSTNode* body);
